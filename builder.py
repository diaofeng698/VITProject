...
def build_attention_layer(network_helper, prefix, config, weights_dict, x):
    ...
    q_w = weights_dict["model." + local_prefix + "query.weight"]
    q_b = weights_dict["model." + local_prefix + "query.bias"]
    ...
    k_w = weights_dict["model." + local_prefix + "key.weight"]
    k_b = weights_dict["model." + local_prefix + "key.bias"]
    ...
    v_w = weights_dict["model." + local_prefix + "value.weight"]
    v_b = weights_dict["model." + local_prefix + "value.bias"]
    ...
    out_w = weights_dict["model." + local_prefix + "out.weight"]
    out_b = weights_dict["model." + local_prefix + "out.bias"]
...
def build_mlp_layer(network_helper, prefix, config, weights_dict, x):
    ...
    #  import pdb
    #  pdb.set_trace()
    fc1_w = weights_dict["model." + local_prefix + "fc1.weight"]
    fc1_b = weights_dict["model." + local_prefix + "fc1.bias"]
    x = network_helper.addLinear(x, fc1_w, fc1_b)

    x = network_helper.addGELU(x)

    fc2_w = weights_dict["model." + local_prefix + "fc2.weight"]
    fc2_b = weights_dict["model." + local_prefix + "fc2.bias"]
...
def build_embeddings_layer(network_helper, prefix, config, weights_dict, input_tensor):
    ...
    cls_token = weights_dict["model." + local_prefix + "cls_token"]
    patch_embeddings_weight = weights_dict["model." + local_prefix + "patch_embeddings.weight"]
    patch_embeddings_bias = weights_dict["model." + local_prefix + "patch_embeddings.bias"]
    position_embeddings = weights_dict["model." + local_prefix + "position_embeddings"]
...
def build_block_layer(network_helper, prefix, config, weights_dict, x):
    ...
    # attention_norm
    attention_norm_weight = weights_dict["model." + local_prefix + "attention_norm.weight"]
    attention_norm_bias = weights_dict["model." + local_prefix + "attention_norm.bias"]
    x = network_helper.addLayerNorm(x, attention_norm_weight, attention_norm_bias, layer_name="model." + local_prefix + "attention_norm.")
    #  network_helper.markOutput(x)
    ...
    # ffn_norm
    fnn_norm_weight = weights_dict["model." + local_prefix + "ffn_norm.weight"]
    fnn_norm_bias = weights_dict["model." + local_prefix + "ffn_norm.bias"]
    x = network_helper.addLayerNorm(x, fnn_norm_weight, fnn_norm_bias, layer_name="model." + local_prefix + "ffn_norm.")
...
def build_encoder_layer(network_helper, prefix, config, weights_dict, x):
    ...
    encoder_norm_weight = weights_dict["model." + prefix + "encoder.encoder_norm.weight"]
    encoder_norm_bias = weights_dict["model." + prefix + "encoder.encoder_norm.bias"]
    x = network_helper.addLayerNorm(x, encoder_norm_weight, encoder_norm_bias, layer_name="model." + prefix + "encoder.encoder_norm.")
...
def build_vision_transformer_layer(network_helper, config, weights_dict, x):
    ...
    #  head.weight [10, 768]
    #  head.bias [10]
    head_w = weights_dict["model.head.weight"]
    head_b = weights_dict["model.head.bias"]
